...
// Ajustar el tamaño de la fuente para el título
$pdf->SetFont('helvetica', 'B', 12); // Fuente en negrita ('B') y tamaño 12 para el título
$pdf->writeHTML('<h1>Ticket de Vehículo</h1>', true, false, true, false, '');

// Ajustar el tamaño de la fuente para el contenido del ticket
$pdf->SetFont('helvetica', '', 8); // Cambia a tamaño 8 para el contenido normal
$html = '
    <p><strong>Tipo de Vehículo:</strong> ' . htmlspecialchars($datosTicket['tipoVehiculo']) . '</p>
    <p><strong>Nombre del Vehículo:</strong> ' . htmlspecialchars($datosTicket['nombreVehiculo']) . '</p>
    <p><strong>Número de Placa:</strong> ' . htmlspecialchars($datosTicket['numeroPlaca']) . '</p>
